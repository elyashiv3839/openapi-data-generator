...
setuptools.setup(
    ...
    description="Generate all valid permutations and invalid permutations - according OpenAPI specification",
    long_description="file: README.md",
    long_description_content_type="text/markdown",
    url="https://github.com/elyashiv3839/openapi-data-generator.git",
    download_url="https://github.com/elyashiv3839/openapi-data-generator/archive/refs/tags/1.0.2.tar.gz",
